        ...
        <div className="submit-form jumbotron">
            ...
            {submitted ? (
                <div>
                    ...
                    <MDBBtn color="success" onClick={newSeminar} className="btn btn-success btn-lg">Save Seminar</MDBBtn>
                  
                    <MDBBtn href="/ListOfSem/" color="secondary"
                    className="btn btn-warning btn-lg">Back to Seminars</MDBBtn>
                </div>
            ) : (
                ...
                <MDBBtn color="success" onClick={saveSeminar} className="btn btn-success btn-lg">Save Seminar</MDBBtn>
